...
int is_play(menu_t *menu, sfRenderWindow *window)
{
    ...
    menu->button.click_size_play.y && menu->button.b >=
    menu->button.click_pos_play.y)
...
int is_exit(menu_t *menu, sfRenderWindow *window)
{
    ...
    menu->button.click_size_exit.y && menu->button.b >=
    menu->button.click_pos_exit.y)
...
int is_htp(menu_t *menu, sfRenderWindow *window)
{
    ...
    menu->button.click_size_htp.y && menu->button.b >=
    menu->button.click_pos_htp.y)
...
int is_param(menu_t *menu, sfRenderWindow *window)
{
    ...
    menu->button.click_size_param.y && menu->button.b >=
    menu->button.click_pos_param.y)
