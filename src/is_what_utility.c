...
int is_order(Index_t *index)
{
    ...
    index->ui_button_utilities.click_pos_order.x +
    index->ui_button_utilities.click_size_order.x &&
    index->ui.coord_mouse_x >= index->ui_button_utilities.click_pos_order.x
    && index->ui.coord_mouse_y <= index->ui_button_utilities.click_pos_order.y
    + index->ui_button_utilities.click_size_order.y && index->ui.coord_mouse_y
    >= index->ui_button_utilities.click_pos_order.y &&
...
{
    if (index->ui.coord_mouse_x <=
    index->ui_button_utilities.click_pos_tchernobyl.x +
    index->ui_button_utilities.click_size_tchernobyl.x
    && index->ui.coord_mouse_x >=
    index->ui_button_utilities.click_pos_tchernobyl.x && index->ui.coord_mouse_y
    <= index->ui_button_utilities.click_pos_tchernobyl.y +
    index->ui_button_utilities.click_size_tchernobyl.y &&
    index->ui.coord_mouse_y >= index->ui_button_utilities.click_pos_tchernobyl.y
    && index->what_is_open == 2) {
