...
void init_text_plus2(menu_t *menu)
{
    ...
    sfText_setPosition(menu->text_settings.txt_plus2, menu->
    text_settings.pos_plus2);
}
...
void init_text_minus2(menu_t *menu)
{
    ...
    sfText_setPosition(menu->text_settings.txt_minus2, menu->
    text_settings.pos_minus2);
}
...
void init_text_go_home(menu_t *menu)
{
    ...
    sfText_setPosition(menu->text_settings.txt_go_home, menu->
    text_settings.pos_go_home);
}