...
int is_resume(Index_t *index)
{
    ...
    index->ui_pause_button.click_pos_resume.y +
    index->ui_pause_button.click_size_resume.y && index->ui.coord_mouse_y >=
    index->ui_pause_button.click_pos_resume.y && index->what_is_open == 4)
...
int is_go_menu(Index_t *index)
{
    ...
    index->ui_pause_button.click_pos_go_menu.y +
    index->ui_pause_button.click_size_go_menu.y && index->ui.coord_mouse_y >=
    index->ui_pause_button.click_pos_go_menu.y && index->what_is_open == 4) {
...
int is_exit2(Index_t *index)
{
    ...
    index->ui_pause_button.click_pos_exit.y +
    index->ui_pause_button.click_size_exit.y && index->ui.coord_mouse_y >=
    index->ui_pause_button.click_pos_exit.y && index->what_is_open == 4) {
...
int is_win(Index_t *index)
{
    ...
    index->ui_pause_button.click_pos_win.y +
    index->ui_pause_button.click_size_win.y && index->ui.coord_mouse_y >=
    index->ui_pause_button.click_pos_win.y && index->what_is_open == 100 ||
